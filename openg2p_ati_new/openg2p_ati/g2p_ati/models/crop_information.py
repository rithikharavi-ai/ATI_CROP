...
class G2PCropInformation(models.Model):
    ...
    water_resource_line_ids = fields.One2many(
        "g2p.crop.information.water.line",
        "crop_information_id",
...
class G2PCropInformationWaterLine(models.Model):
    _name = "g2p.crop.information.water.line"
    _description = "Crop Information Water Line"
