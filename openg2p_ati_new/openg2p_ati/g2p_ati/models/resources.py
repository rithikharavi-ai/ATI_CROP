...
class G2PWaterSourceMethod(models.Model):
    _name = "g2p.water.source.method"
    _description = "Water Source Method"

    _rec_name = "name"
    _order = "name ASC"

    name = fields.Char(required=True)
    water_source_id = fields.Many2one('g2p.water.source', string="Water Source", required=True)
